...
urlpatterns = [
    ...
    path('blog/<slug:slug>/<int:id>/', views.blog_post_detail, name='blog-post-detail'),
    ...
    path('session-timeout/', views.session_timeout, name='session_timeout'),
    ...
    path('strefa-wiedzy/profil/<str:pk>/', views.userProfile, name="user-profile"),
    path('strefa-wiedzy/edytuj-uzytkownika/', views.updateUser, name="update-user"),
